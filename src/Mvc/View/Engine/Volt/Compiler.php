...
class Compiler implements InjectionAwareInterface
{
    ...
    private const PHVOLT_T_INTEGER = 258;
    private const PHVOLT_T_DOUBLE = 259;
    private const PHVOLT_T_STRING = 260;
    private const PHVOLT_T_NULL = 261;
    private const PHVOLT_T_FALSE = 262;
    private const PHVOLT_T_TRUE = 263;
    private const PHVOLT_T_IDENTIFIER = 265;

    /* Operators */
    private const PHVOLT_T_ADD = '+';
    private const PHVOLT_T_SUB = '-';
    private const PHVOLT_T_MUL = '*';
    private const PHVOLT_T_DIV = '/';
    private const PHVOLT_T_MOD = '%';
    private const PHVOLT_T_AND = 266;
    private const PHVOLT_T_OR = 267;
    private const PHVOLT_T_CONCAT = '~';
    private const PHVOLT_T_PIPE = '|';

    private const PHVOLT_T_DOT = '.';
    private const PHVOLT_T_COMMA = 269;

    private const PHVOLT_T_NOT = '!';
    private const PHVOLT_T_LESS = '<';
    private const PHVOLT_T_LESSEQUAL = 270;
    private const PHVOLT_T_GREATER = '>';
    private const PHVOLT_T_GREATEREQUAL = 271;
    private const PHVOLT_T_EQUALS = 272;
    private const PHVOLT_T_NOTEQUALS = 273;
    private const PHVOLT_T_IDENTICAL = 274;
    private const PHVOLT_T_NOTIDENTICAL = 275;
    private const PHVOLT_T_RANGE = 276;
    private const PHVOLT_T_ASSIGN = '=';
    private const PHVOLT_T_COLON = 277;
    private const PHVOLT_T_QUESTION = '?';
    private const PHVOLT_T_POW = 278;
    private const PHVOLT_T_INCR = 279;
    private const PHVOLT_T_DECR = 280;
    private const PHVOLT_T_ADD_ASSIGN = 281;
    private const PHVOLT_T_SUB_ASSIGN = 282;
    private const PHVOLT_T_MUL_ASSIGN = 283;
    private const PHVOLT_T_DIV_ASSIGN = 284;

    private const PHVOLT_T_PARENTHESES_OPEN = '(';
    private const PHVOLT_T_PARENTHESES_CLOSE = ')';
    private const PHVOLT_T_SBRACKET_OPEN = '[';
    private const PHVOLT_T_SBRACKET_CLOSE = ']';
    private const PHVOLT_T_CBRACKET_OPEN = '{';
    private const PHVOLT_T_CBRACKET_CLOSE = '}';

    /** Reserved words */
    private const PHVOLT_T_IF = 300;
    private const PHVOLT_T_ELSE = 301;
    private const PHVOLT_T_ELSEIF = 302;
    private const PHVOLT_T_ENDIF = 303;
    private const PHVOLT_T_FOR = 304;
    private const PHVOLT_T_ENDFOR = 305;
    private const PHVOLT_T_SET = 306;
    private const PHVOLT_T_BLOCK = 307;
    private const PHVOLT_T_ENDBLOCK = 308;
    private const PHVOLT_T_IN = 309;
    private const PHVOLT_T_EXTENDS = 310;
    private const PHVOLT_T_IS = 311;
    private const PHVOLT_T_DEFINED = 312;
    private const PHVOLT_T_INCLUDE = 313;
    private const PHVOLT_T_CACHE = 314;
    private const PHVOLT_T_ENDCACHE = 315;
    private const PHVOLT_T_DO = 316;
    private const PHVOLT_T_AUTOESCAPE = 317;
    private const PHVOLT_T_ENDAUTOESCAPE = 318;
    private const PHVOLT_T_CONTINUE = 319;
    private const PHVOLT_T_BREAK = 320;
    private const PHVOLT_T_ELSEFOR = 321;
    private const PHVOLT_T_MACRO = 322;
    private const PHVOLT_T_ENDMACRO = 323;
    private const PHVOLT_T_WITH = 324;
    private const PHVOLT_T_CALL = 325;
    private const PHVOLT_T_ENDCALL = 326;
    private const PHVOLT_T_RETURN = 327;

    /** Delimiters */
    private const PHVOLT_T_OPEN_DELIMITER  = 330;
    private const PHVOLT_T_CLOSE_DELIMITER  = 331;
    private const PHVOLT_T_OPEN_EDELIMITER  = 332;
    private const PHVOLT_T_CLOSE_EDELIMITER  = 333;

    /** Special Tokens */
    private const PHVOLT_T_FCALL = 350;
    private const PHVOLT_T_EXPR = 354;
    private const PHVOLT_T_QUALIFIED = 355;
    private const PHVOLT_T_ENCLOSED = 356;
    private const PHVOLT_T_RAW_FRAGMENT = 357;
    private const PHVOLT_T_EMPTY_STATEMENT = 358;
    private const PHVOLT_T_ECHO = 359;
    private const PHVOLT_T_ARRAY = 360;
    private const PHVOLT_T_ARRAYACCESS = 361;
    private const PHVOLT_T_NOT_ISSET = 362;
    private const PHVOLT_T_ISSET = 363;
    private const PHVOLT_T_RESOLVED_EXPR = 364;
    private const PHVOLT_T_SLICE = 365;
    private const PHVOLT_T_TERNARY = 366;
    private const PHVOLT_T_NOT_IN = 367;

    private const PHVOLT_T_MINUS = 368;
    private const PHVOLT_T_PLUS = 369;

    private const PHVOLT_T_EMPTY = 380;
    private const PHVOLT_T_EVEN = 381;
    private const PHVOLT_T_ODD = 382;
    private const PHVOLT_T_NUMERIC = 383;
    private const PHVOLT_T_SCALAR = 384;
    private const PHVOLT_T_ITERABLE = 385;

    private const PHVOLT_T_ISEMPTY = 386;
    private const PHVOLT_T_ISEVEN = 387;
    private const PHVOLT_T_ISODD = 388;
    private const PHVOLT_T_ISNUMERIC = 389;
    private const PHVOLT_T_ISSCALAR = 390;
    private const PHVOLT_T_ISITERABLE = 391;

    private const PHVOLT_T_NOT_ISEMPTY = 392;
    private const PHVOLT_T_NOT_ISEVEN = 393;
    private const PHVOLT_T_NOT_ISODD = 394;
    private const PHVOLT_T_NOT_ISNUMERIC = 395;
    private const PHVOLT_T_NOT_ISSCALAR = 396;
    private const PHVOLT_T_NOT_ISITERABLE = 397;

    private const PHVOLT_T_RAW = 400;
    private const PHVOLT_T_ENDRAW = 401;

    /* switch-case statement */
    private const PHVOLT_T_SWITCH = 411;
    private const PHVOLT_T_CASE = 412;
    private const PHVOLT_T_DEFAULT = 413;
    private const PHVOLT_T_ENDSWITCH = 414;
    ...
    public function attributeReader(?array $expr): string
    {
        ...
        if ($left["type"] == self::PHVOLT_T_IDENTIFIER) {
            $variable = $left["value"];
        ...
        if ($right["type"] == self::PHVOLT_T_IDENTIFIER) {
    ...
    public function compile(?string $templatePath, bool $extendsMode = false)
    {
         ...
         */
        if (true === isset($options["always"])) {
            $compileAlways = $options["always"];
            if (false === is_bool($compileAlways)) {
         ...
         */
        if (true === isset($options["separator"])) {
             $compiledSeparator = $options["separator"];
            if (false === is_string($compiledSeparator)) {
         ...
         */
        if (true === isset($options["extension"])) {
            $compiledExtension = $options["extension"];
            if (false === is_string($compiledExtension)) {
                throw new Exception("The 'extension' option must be a string");
            }
        } else {
         ...
         */
        if (true === is_string($compiledPath)) {
            /**
             * Calculate the template realpath's
             */
            if (false === empty($compiledPath)) {
                /**
        ...
        } elseif (true === is_object($compiledPath) && $compiledPath instanceof Closure) {
            /**
             ...
             */
            if (false === is_string($compiledTemplatePath)) {
                throw new Exception(
    ...
    public function compileAutoEscape(?array $statement, bool $extendsMode): string
    {
         ...
         */
        if (true === isset($statement["enable"])) {
            $autoescape = $statement["enable"];
        } else {
    ...
    public function compileEcho(?array $statement): string
    {
        ...
        if ($expr["type"] === self::PHVOLT_T_FCALL) {
            if ($this->isTagFactory($expr) === true) {
                $exprCode = $this->expression($expr, true);
            }

            $name = $expr["name"];
            if ($name["type"] === self::PHVOLT_T_IDENTIFIER) {
                /**
     ...
     * @return string|array
     */
    public function compileFile(?string $path, ?string $compiledPath, bool $extendsMode = false): string|array
    {
    ...
    public function compileForeach(?array $statement, bool $extendsMode = false): string
    {
        ...
        if (true === is_array($blockStatements)) {
            foreach ($blockStatements as $bstatement) {
                /**
                 * Check if the statement is valid
                 */
                if (true === isset($bstatement["type"])) {
                    $type = $bstatement["type"];
                    if ($type == self::PHVOLT_T_ELSEFOR) {
         ...
         */
        if (true === isset($loopContext[$level])) {
         ...
         */
        if (true === isset($statement["if_expr"])) {
    ...
    public function compileForElse(): string
    {
        ...
        if (false === isset($this->forElsePointers[$level])) {
            return "";
        }
        $prefix = $this->forElsePointers[$level];
        if (true === isset($this->loopPointers[$level])) {
    ...
    public function compileInclude(?array $statement): string
    {
        ...
        if ($pathExpr["type"] == 260) {
             ...
             * parameters
             */
            if (false === isset($statement["params"])) {
                /**
                 * Get the static path
                 */
                $path = $pathExpr["value"];
    ...
    public function compileMacro(?array $statement, bool $extendsMode): string
    {
         ...
         */
        if (false === isset($this->macros[$name])) {
        ...
        if (false === isset($statement["parameters"])) {
            ...
            foreach ($parameters as $position => $parameter) {
                ...
                if (true === isset($parameter["default"])) {
         ...
         */
        if (true === isset($statement["block_statments"])) {
            $blockStatements = $statement["block_statments"];
            /**
             * Process statements block
             */
    ...
    public function compileSet(?array $statement): string
    {
         ...
         */
        if (true === isset($statement["assignments"])) {
        ...
        foreach ($assignments as $assignment) {
            ...
            switch ($assignment["op"]) {
                case self::PHVOLT_T_ADD_ASSIGN:
                    $compilation .= " " . $target . " += " . $exprCode . ";";
                    break;

                case self::PHVOLT_T_SUB_ASSIGN:
                    $compilation .= " " . $target . " -= " . $exprCode . ";";
                    break;

                case self::PHVOLT_T_MUL_ASSIGN:
                    $compilation .= " " . $target . " *= " . $exprCode . ";";
                    break;

                case self::PHVOLT_T_DIV_ASSIGN:
                    $compilation .= " " . $target . " /= " . $exprCode . ";";
                    break;
    ...
    public function compileSwitch(?array $statement, bool $extendsMode = false): string
    {
         ...
         */
        if (true === isset($statement["case_clauses"])) {
            $lines = $this->statementList($statement["case_clauses"], $extendsMode);
    ...
    final public function expression(?array $expr, bool $doubleQuotes = false): string
    {
        ...
        while (true) {
            if (true === is_array($extensions)) {
                ...
                if (true === is_string($exprCode)) {
                    break;
                }
            }

            if (false === isset($expr["type"])) {
                $items = [];
            ...
            switch ($type) {
                case self::PHVOLT_T_NOT:
                    $exprCode = "!" . $rightCode;
                    break;

                case self::PHVOLT_T_MUL:
                    $exprCode = $leftCode . " * " . $rightCode;
                    break;

                case self::PHVOLT_T_ADD:
                    $exprCode = $leftCode . " + " . $rightCode;
                    break;

                case self::PHVOLT_T_SUB:
                    $exprCode = $leftCode . " - " . $rightCode;
                    break;

                case self::PHVOLT_T_DIV:
                    $exprCode = $leftCode . " / " . $rightCode;
                    break;
                ...
                case self::PHVOLT_T_NULL:
                    $exprCode = "null";
                    break;

                case self::PHVOLT_T_FALSE:
                    $exprCode = "false";
                    break;

                case self::PHVOLT_T_TRUE:
                    $exprCode = "true";
                    break;

                case self::PHVOLT_T_IDENTIFIER:
                    $exprCode = "$" . $expr["value"];
                    break;

                case self::PHVOLT_T_AND:
                    $exprCode = $leftCode . " && " . $rightCode;
                    break;
                ...
                case self::PHVOLT_T_RANGE:
                    $exprCode = "range(" . $leftCode . ", " . $rightCode . ")";
                    break;

                case self::PHVOLT_T_FCALL:
                    $exprCode = $this->functionCall($expr, $doubleQuotes);
                    break;

                case self::PHVOLT_T_ENCLOSED:
                    $exprCode = "(" . $leftCode . ")";
                    break;

                case self::PHVOLT_T_ARRAYACCESS:
                    $exprCode = $leftCode . "[" . $rightCode . "]";
                    break;

                case self::PHVOLT_T_SLICE:
                    /**
                     * Evaluate the start part of the slice
                     */
                    if (true === isset($expr["start"])) {
                        $startCode = $this->expression($expr["start"], $doubleQuotes);
                    } else {
                        $startCode = "null";
                    }
                     ...
                     */
                    if (true === isset($expr["end"])) {
                        $endCode = $this->expression($expr["end"], $doubleQuotes);
                    } else {
                        $endCode = "null";
                    }
                ...
                case self::PHVOLT_T_NOT_ISSET:
                    $exprCode = "!isset(" . $leftCode . ")";
                    break;

                case self::PHVOLT_T_ISSET:
                    $exprCode = "isset(" . $leftCode . ")";
                    break;

                case self::PHVOLT_T_NOT_ISEMPTY:
                    $exprCode = "!empty(" . $leftCode . ")";
                    break;

                case self::PHVOLT_T_ISEMPTY:
                    $exprCode = "empty(" . $leftCode . ")";
                    break;

                case self::PHVOLT_T_NOT_ISEVEN:
                    $exprCode = "!(((" . $leftCode . ") % 2) == 0)";
                    break;

                case self::PHVOLT_T_ISEVEN:
                    $exprCode = "(((" . $leftCode . ") % 2) == 0)";
                    break;

                case self::PHVOLT_T_NOT_ISODD:
                    $exprCode = "!(((" . $leftCode . ") % 2) != 0)";
                    break;

                case self::PHVOLT_T_ISODD:
                    $exprCode = "(((" . $leftCode . ") % 2) != 0)";
                    break;

                case self::PHVOLT_T_NOT_ISNUMERIC:
                    $exprCode = "!is_numeric(" . $leftCode . ")";
                    break;

                case self::PHVOLT_T_ISNUMERIC:
                    $exprCode = "is_numeric(" . $leftCode . ")";
                    break;

                case self::PHVOLT_T_NOT_ISSCALAR:
                    $exprCode = "!is_scalar(" . $leftCode . ")";
                    break;

                case self::PHVOLT_T_ISSCALAR:
                    $exprCode = "is_scalar(" . $leftCode . ")";
                    break;

                case self::PHVOLT_T_NOT_ISITERABLE:
                    $exprCode = "!(is_array(" . $leftCode . ") || (" . $leftCode . ") instanceof Traversable)";
                    break;

                case self::PHVOLT_T_ISITERABLE:
                    $exprCode = "(is_array(" . $leftCode . ") || (" . $leftCode . ") instanceof Traversable)";
                    break;

                case self::PHVOLT_T_IN:
                    $exprCode = "\$this->isIncluded(" . $leftCode . ", " . $rightCode . ")";
                    break;

                case self::PHVOLT_T_NOT_IN:
                    $exprCode = "!\$this->isIncluded(" . $leftCode . ", " . $rightCode . ")";
                    break;

                case self::PHVOLT_T_TERNARY:
                    $exprCode = "(" . $this->expression($expr["ternary"], $doubleQuotes) .
                                " ? " . $leftCode . " : " . $rightCode . ")";
                    break;

                case self::PHVOLT_T_MINUS:
                    $exprCode = "-" . $rightCode;
                    break;

                case self::PHVOLT_T_PLUS:
                    $exprCode = "+" . $rightCode;
                    break;

                case self::PHVOLT_T_RESOLVED_EXPR:
                    $exprCode = $expr["value"];
                    break;
    ...
    public function functionCall(?array $expr, bool $doubleQuotes = false): string
    {
         ...
         */
        if ($nameType === self::PHVOLT_T_IDENTIFIER) {
            $name = $nameExpr["value"];
            ...
            if (true === is_array($functions)) {
                if (true === isset($functions[$name])) {
            ...
            if ($name === "super") {
                ...
                if (true === is_array($extendedBlocks)) {
                    $currentBlock = $this->currentBlock;
                    if (true === isset($extendedBlocks[$currentBlock])) {
            ...
            if (method_exists("Phalcon\\Tag", $method)) {
                if (true === isset($arrayHelpers[$name])) {
     ...
     * contexts
     *
     * @throw \Phalcon\Mvc\View\Engine\Volt\Exception
     * @return string
     */
    public function getUniquePrefix(): string
    {
        ...
        if (false === is_string($this->prefix)) {
    ...
    public function parse(?string $viewCode): array
    {
        ...
        return phvolt_parse_view($viewCode, $currentPath); // TODO: check paserview
    }
    ...
    protected function compileSource(?string $viewCode, bool $extendsMode = false): string
    {
        ...
        if (true === is_array($options)) {
             ...
             */
            if (true === isset($options["autoescape"])) {
                $autoescape = $options["autoescape"];
                if (false === is_bool($autoescape)) {
     ...
     * @param string $path
     *
     * @throw \Phalcon\Mvc\View\Exception
     * @return string
     */
    protected function getFinalPath(string $path)
    {
        ...
        if (true === is_object($view)) {
            $viewsDirs = $view->getViewsDir();

            if (true === is_array($viewsDirs)) {
    ...
    final protected function statementList(?array $statements, bool $extendsMode = false): string
    {
        ...
        foreach ($statements as $statement) {
            ...
            if (true === is_array($extensions)) {
                ...
                if (true === is_string($tempCompilation)) {
    ...
    final protected function statementListOrExtends(mixed $statements)
    {
        ...
        if (false === isset($statements["type"])) {
            foreach ($statements as $statement) {
                if (false === is_array($statement)) {
    ...
    /**
     * Check if the expression is a tag factory
     *
    ...
    private function isTagFactory(array $expression): bool
    {
         ...
         */
        if (true === isset($expression["name"])) {
            $name = $expression["name"];
            if (true === isset($name["left"])) {
                $left = $name["left"];
                /**
                 * There is a value, get it and check it
                 */
                if (true === isset($left["value"])) {
                    return ($left["value"] === "tag");
                } else {
                    /**
                     * There is a "name" so that is nested, recursion
                     */
                    if (true === isset($left["name"]) && true === is_array($left["name"])) {
